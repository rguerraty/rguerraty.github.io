...
<div style="font-size: 18px;">
  <table>
    ...
    <tbody>
      <tr>
        <td><em>Positivity Constraints on the EFT of Inflation <a href="/assets/documents/COSMO-26.pdf" target="_blank"> [slides <i class="fa-regular fa-file-pdf"></i>]</a></em></td>
